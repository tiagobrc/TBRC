...
```bash
rsync -aP -e "ssh -p 6123" frontend/ trezende@epsilon.rockefeller.edu:/home/trezende/ShinyApps/tbrc/
rsync -aP backend/ trezende@login06-hpc.rockefeller.edu:/lustre/fs4/vict_lab/scratch/trezende/pipelines/TBRC/
```
